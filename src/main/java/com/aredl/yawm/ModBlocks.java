...
public class ModBlocks {
    ...
    public static final Block DEEPWOOD_PRESSURE_PLATE = register(
            ...
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_PRESSURE_PLATE).sounds(BlockSoundGroup.NETHER_WOOD).burnable(),
            true
    );
    ...
    public static final Block DEEPWOOD_BUTTON = register(
            ...
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_BUTTON).sounds(BlockSoundGroup.NETHER_WOOD).burnable(),
            true
    );
    ...
    public static final Block DEEPWOOD_TRAPDOOR = register(
            ...
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_TRAPDOOR).sounds(BlockSoundGroup.NETHER_WOOD).burnable(),
            true
    );
